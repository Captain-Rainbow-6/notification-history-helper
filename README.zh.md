...
这个项目起于我使用 Redmi K80／HyperOS 的经历：我本来想做一个支持微信QQ查看撤回消息的APP，期间发现Android手机应该是自带的历史通知功能的，但是我的Android红米手机却没有这个功能，最后确定是傻逼小米把它隐藏了，于是做了这个小工具，打开这个隐藏的入口，再加一个一键直达的桌面快捷方式。
